...
2. **Filtre actif de rétroaction (1.6 Hz)** : Atténue le bruit secteur de $50\text{ Hz}$ du réseau électrique ($C_3 = 100\text{ µF}$, $R_3 = 100\text{ k}\Omega$).
3. **Filtre de sortie (1.6 kHz)** : Élimine les parasites haute fréquence générés par l'électronique ($C_2 = 1\text{ }\mu\text{F}$, $R_4 = 1\text{ k}\Omega$).
